...
const blocks: Cfg<BuildingBlockCfg & HasRecipes<"builders" | "alchemy" | "furnace">> = {
  ...
  factory: [
    ...
    {
      id: "Block_Refractory",
      name: "Refractory Block",
      color: "#742729",
      resourceType: "Refractorys",
      builders: { input: "$Refractorys", output: `Block_Refractory` }
    },
    {
    ...
    {
      id: "Block_High_Refractory",
      name: "High Refractory Block",
      color: "#742729",
      resourceType: "High_Refractorys",
      builders: { input: "$High_Refractorys", output: `Block_High_Refractory` }
    },
    {
