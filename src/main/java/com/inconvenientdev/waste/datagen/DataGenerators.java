...
@Mod.EventBusSubscriber(modid = Waste.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
  ...
  public static void gatherData(GatherDataEvent event) {
    ...
    generator.addProvider(new ModItemBlockModelProvider(generator, existingFileHelper));
